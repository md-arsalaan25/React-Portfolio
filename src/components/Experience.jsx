...
const Experience = () => {
  return (
    <div className="border-b border-neutral-900 pb-4">
        ...
        className="my-20 text-center text-4xl">Internships</motion.h2>
    <div>
    {EXPERIENCES.map((experiences, index) => (
        <div key={index} className="mb-8 flex flex-wrap lg:justify-center"> 
            ...
            <h6 className="mb-6 font-semibold">{experiences.role} - <span className=" text-purple-300">{experiences.company}</span>
            </h6>
